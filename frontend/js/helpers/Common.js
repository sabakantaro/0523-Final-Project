...
export const accountEndpoint = `${baseUrl}/accounts`;
export const categoryEndpoint = `${baseUrl}/categories`;
export const transactionEndpoint = `${baseUrl}/transactions`;
 ...
 * HTML
 */
export const mobileMenuBarHTML = `
...
export const mobileMenuHTML = `
  <div id="mobileMenu" class="hidden lg:hidden space-y-4 px-4 absolute bg-white w-full z-50">
